...
import 'package:flutter_blue_example/flutter_blue_app.dart';
import 'package:flutter_blue_example/widget_characteristic_tile.dart';
import 'package:flutter_blue_example/widget_descriptor_tile.dart';
import 'package:flutter_blue_example/widget_scan_result_tile.dart';
import 'package:flutter_blue_example/widget_service_title.dart';
  ...
  _startScan() {
    _scanSubscription = _flutterBlue.scan(
        timeout: const Duration(
            seconds:
                15), // This determines how long the scanning needs to happen
        withServices: [
